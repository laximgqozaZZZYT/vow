 ...
 */
function createApiKeyService(supabase: SupabaseClient): ApiKeyService {
...
export function createApiKeyRouter(): Hono {
   ...
   */
  router.delete('/:keyId', async (c: Context) => {
    const userId = getUserId(c);
