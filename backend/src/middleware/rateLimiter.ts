...
export class RateLimiter {
   ...
   */
  constructor(supabase: SupabaseClient, config: RateLimitConfig = DEFAULT_RATE_LIMIT_CONFIG) {
   ...
   */
  private getWindowStart(timestamp: Date = new Date()): Date {
   ...
   */
  private getResetTime(windowStart: Date): Date {
