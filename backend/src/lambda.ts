...
import { handle, type LambdaEvent, type APIGatewayProxyResult } from 'hono/aws-lambda';
...
export async function handler(
  ...
  return apiHandler(event as LambdaEvent, context);
}
