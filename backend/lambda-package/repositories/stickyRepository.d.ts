 ...
 */
export declare class StickyRepository extends BaseRepository<StickyDb> {
    /**
     ...
     */
    getByOwner(ownerType: string, ownerId: string): Promise<StickyDb[]>;
    /**
     ...
     */
    getIncomplete(ownerType: string, ownerId: string): Promise<StickyDb[]>;
    /**
     ...
     */
    getCompleted(ownerType: string, ownerId: string, limit?: number): Promise<StickyDb[]>;
    /**
     ...
     */
    countByStatus(ownerType: string, ownerId: string, completed: boolean): Promise<number>;
    /**
     ...
     */
    markCompleted(id: string): Promise<StickyDb | null>;
    /**
     ...
     * @returns The updated sticky if found, null otherwise.
     */
    markIncomplete(id: string): Promise<StickyDb | null>;
}
//# sourceMappingURL=stickyRepository.d.ts.map