 ...
 */
function createDashboardDataService(supabase) {
...
export function createWidgetRouter() {
    ...
    router.get('/progress', async (c) => {
        ...
        try {
            ...
            logger.error('Widget progress request failed', error instanceof Error ? error : new Error(String(error)), { userId });
    ...
    router.get('/stats', async (c) => {
        ...
        try {
            ...
            logger.error('Widget stats request failed', error instanceof Error ? error : new Error(String(error)), { userId });
            if (error instanceof DataFetchError) {
                return c.json({
                    error: 'DATA_FETCH_ERROR',
                    message: getUserFriendlyMessage(error),
    ...
    router.get('/next', async (c) => {
        ...
        try {
            ...
            logger.error('Widget next habits request failed', error instanceof Error ? error : new Error(String(error)), { userId });
            if (error instanceof DataFetchError) {
                return c.json({
                    error: 'DATA_FETCH_ERROR',
                    message: getUserFriendlyMessage(error),
    ...
    router.get('/stickies', async (c) => {
        ...
        try {
            ...
            logger.error('Widget stickies request failed', error instanceof Error ? error : new Error(String(error)), { userId });
            if (error instanceof DataFetchError) {
                return c.json({
                    error: 'DATA_FETCH_ERROR',
                    message: getUserFriendlyMessage(error),
     ...
     */
    router.post('/habits/:habitId/complete', async (c) => {
        const userId = getApiKeyUserId(c);
        ...
        try {
            ...
            logger.error('Widget habit complete request failed', error instanceof Error ? error : new Error(String(error)), { userId, habitId });
            if (error instanceof DataFetchError) {
                return c.json({
                    error: 'DATA_FETCH_ERROR',
                    message: getUserFriendlyMessage(error),
     ...
     */
    router.post('/stickies/:stickyId/toggle', async (c) => {
        const userId = getApiKeyUserId(c);
        ...
        try {
            ...
            logger.error('Widget sticky toggle request failed', error instanceof Error ? error : new Error(String(error)), { userId, stickyId });
            if (error instanceof DataFetchError) {
                return c.json({
                    error: 'DATA_FETCH_ERROR',
                    message: getUserFriendlyMessage(error),
