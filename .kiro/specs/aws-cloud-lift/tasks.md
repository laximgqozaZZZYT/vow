...
習慣管理ダッシュボードアプリケーションの開発環境をAWSクラウドにサーバーレスアーキテクチャで構築するための実装タスクです。

## タスク

- [x] 1. Dockerコンテナ化
- [x] 1.1 Dockerfileを作成
- [x] 1.2 .dockerignoreを作成
- [x] 1.3 docker-compose.ymlを作成
- [x] 2. Next.js設定の調整
- [x] 2.1 next.config.tsを更新
- [x] 2.2 amplify.ymlを作成
- [x] 3. AWS CDKプロジェクトのセットアップ
- [x] 3.1 CDKプロジェクト構造を作成
- [x] 3.2 CDK依存関係をインストール
- [x] 4. Amplify Hostingスタックの実装
- [x] 4.1 SSMパラメータストアの設定
- [x] 4.2 Amplify Appの定義
- [x] 4.3 ブランチ設定
- [x] 5. 環境変数の設定
- [x] 5.1 .env.exampleを更新
- [x] 5.2 SSMパラメータを作成（手動）
- [x] 6. ローカル開発環境の動作確認
- [x] 6.1 docker-compose起動確認
- [x] 6.2 ホットリロード確認
- [x] 7. CDKデプロイ
- [x] 7.1 CDK Bootstrap
- [x] 7.2 CDK Synth
- [x] 7.3 CDK Deploy
- [x] 8. Amplify Hosting動作確認
- [x] 8.1 GitHub連携確認
- [x] 8.2 自動デプロイ確認
- [x] 8.3 アプリケーション動作確認
- [x] 9. ドキュメントの更新
- [x] 9.1 CLOUD_DEV_SETUP.mdを更新
- [x] 9.2 トラブルシューティングを追加
...
2026-01-19 - AWS開発環境クラウドリフト完了
- Amplify Hosting URL: https://develop.d1zmna50iwo9dv.amplifyapp.com
- GitHub連携: laximgqozaZZZYT/vow (developブランチ)
