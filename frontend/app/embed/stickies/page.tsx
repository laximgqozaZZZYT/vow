...
import WidgetStickies from '../components/Widget.Stickies';

/**
 * Embed Stickies Page - Stickies widget for iframe embedding
 *
 * Query Parameters:
...
function StickiesPageContent() {
  ...
  return <WidgetStickies apiKey={apiKey} theme={validTheme} />;
}
